...
const manifest = {
    id: "org.animesland.addon.v4",
    version: "4.0.0",
    name: "AnimesLand Final",
    description: "Assista animes do AnimesLand. Versão com correção de player FHD.",
...
builder.defineStreamHandler(async ({ type, id }) => {
    ...
    return {
        streams: [
            ...
            {
                name: "AnimesLand FHD",
                title: `FHD - Opção Alternativa (MP4)`,
                // Alguns dispositivos preferem o link direto sem index.m3u8 se o m3u8 falhar
                url: streamUrl.replace("/index.m3u8", ""),
                behaviorHints: {
                    notWebReady: false,
                    proxyHeaders: {
                        "request": {
            ...
            {
                name: "AnimesLand",
                title: "Assistir no Navegador (Site)",
                externalUrl: epUrl
            }
        ]
    };
