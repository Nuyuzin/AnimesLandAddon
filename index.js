...
const manifest = {
    id: "org.animesland.addon.v5",
    version: "5.0.0",
    name: "AnimesLand REAL FHD",
    description: "Assista animes do AnimesLand. Versão com resolução dinâmica de player.",
...
builder.defineStreamHandler(async ({ type, id }) => {
    ...
    // Link de stream FHD direto baseado na dica do usuário
    ...
    return {
        streams: [
            ...
            {
                name: "AnimesLand",
                title: "Assistir no Navegador (Link Externo)",
                externalUrl: epUrl
            }
        ]
    };
